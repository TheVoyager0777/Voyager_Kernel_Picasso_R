...
ifneq "$(KERNELVERSION)" "4.19.181"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "Android (7416131, based on r416183c) clang version 12.0.6 (https://android.googlesource.com/toolchain/llvm-project c935d99d7cf2016289302412d708641d52d2f7ee)"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" ".."
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "/home/han/clangg/clang-r416183c/bin/clang -pipe -flto"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/home/han/complier/cbl/bin/aarch64-linux-gnu-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "/home/han/complier/cbl/bin/aarch64-linux-gnu-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "/home/han/complier/cbl/bin/aarch64-linux-gnu-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=/home/han/complier/cbl/bin/aarch64-linux-gnu- --gcc-toolchain=/home/han/complier/cbl -no-integrated-as  -Wno-misleading-indentation  -Wno-bool-operation -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
