...
#define CLOCK_REALTIME_RES 108 /* offsetof(struct vdso_data, hrtimer_res) */
...
#define VDSO_TB_SEQ_COUNT 80 /* offsetof(struct vdso_data, tb_seq_count) */
#define VDSO_CS_MONO_MULT 84 /* offsetof(struct vdso_data, cs_mono_mult) */
#define VDSO_CS_RAW_MULT 92 /* offsetof(struct vdso_data, cs_raw_mult) */
#define VDSO_CS_SHIFT 88 /* offsetof(struct vdso_data, cs_shift) */
#define VDSO_TZ_MINWEST 96 /* offsetof(struct vdso_data, tz_minuteswest) */
#define VDSO_TZ_DSTTIME 100 /* offsetof(struct vdso_data, tz_dsttime) */
#define VDSO_USE_SYSCALL 104 /* offsetof(struct vdso_data, use_syscall) */
